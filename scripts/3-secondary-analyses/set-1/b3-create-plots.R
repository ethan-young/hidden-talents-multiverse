...
load("multiverse-objects/3-secondary-analyses/set-1/b2-extracted-effects.Rdata")
...
secondary1b_working_memory <- 
  plot_grid(
    ...
    align       = "hv", 
    axis        = "tb",
    rel_widths  = c(.2,.125,.05,.125,.125,.05,.125,.2)
  ) +
...
# Save Plots --------------------------------------------------------------
ggsave(
  plot     = secondary1b_working_memory, 
  device   = "pdf", 
  filename = "figures/secondary/set-1/b1-spec-curve-updating.pdf", 
  width    = 14,
  height   = 7.5,
  units    = "in",
  dpi      = "retina"
...
ggsave(
  plot     = secondary1b_interactions, 
  device   = "pdf", 
  filename = "figures/secondary/set-1/b1-interactions.pdf", 
  width    = 13.33,
  height   = 3.75,
  units    = "in",
  dpi      = "retina"
