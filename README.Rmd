...
This repository contains data, code, and (some) output for a manuscript entitled "Hidden talents in context: Cognitive performance with abstract versus ecological stimuli among adversity-exposed youth" submitted to and under review at *Child Development*.
